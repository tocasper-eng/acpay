...
go
--單據核准
if exists (select name from sysobjects where name = 'ep_66d_cn')
   drop procedure ep_66d_cn 
go
--exec .dbo.ep_66d_closen '66d_00_0000000000014','dddd' 
--select chjernoc,chjernoz,menuflag, * from eep_tdh where menuflag= '66d_00_0000000000014'

create procedure ep_66d_cn
(
@menuflag char(20) ,
@chjerno  nvarchar(99) 
)
