...
| 關聯定義 | `TBLDEF` 表 — 22 筆 parent-child 關聯 |
...
eep_bmd, eep_bmh, eep_comp, eep_d01, eep_dac, eep_item, eep_iwd_10, eep_iwd_20, eep_iwh, eep_menu, eep_num8, eep_numh, eep_plant, eep_pos, eep_posi, eep_tdd, eep_tdh, eep_tod, eep_toh, eep_trd, eep_trh, eep_ware, mes_itio, pos, pos_log, pos_tod, vw_POS_CRM_ACRTA, vw_POS_CRM_ACRTB, vw_POS_CRM_ACRTC, vw_POS_CRM_ACRTD, 系統別

## HTML 架構

| 區域 | 說明 |
|------|------|
| 左側導航欄 | 16 個 menunum 項目，點擊切換 ERD |
