...
go
--單據核准
if exists (select name from sysobjects where name = 'ep_62j_cn')
   drop procedure ep_62j_cn 
go
--exec .dbo.ep_62j_closen '62j_00_0000000000014','dddd' 
--select chjernoc,chjernoz,menuflag, * from eep_toh where menuflag= '62j_00_0000000000014'

create procedure ep_62j_cn
(
@menuflag char(20) ,
@chjerno  nvarchar(99) 
)
