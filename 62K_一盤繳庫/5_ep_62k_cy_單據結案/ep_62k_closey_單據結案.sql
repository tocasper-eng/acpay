...
go
--單據結案
if exists (select name from sysobjects where name = 'ep_62k_closey')
   drop procedure ep_62k_closey
go
--exec .dbo.ep_62k_closey '62k_00_0000000000014','dddd' 
--select chjernoc,chjernoz,menuflag, * from eep_trh where menuflag= '62k_00_0000000000014'

create procedure ep_62k_closey
(
@menuflag char(20) ,
@chjerno  nvarchar(99) 
)
