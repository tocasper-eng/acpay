USE acpay
GO
IF OBJECT_ID(N'dbo.ep_eep_chjernoi', N'P') IS NOT NULL
    DROP PROCEDURE dbo.ep_eep_chjernoi;
GO

/* 
declare @chjernoi nvarchar(99) 
exec .dbo.ep_eep_chjernoi  'casper' , 'yu-cheng chuang','database','solution','computer' , @chjernoi output 

print @chjernoi 
*/
CREATE PROCEDURE dbo.ep_eep_chjernoi
...
BEGIN
    ...
    SET @a =  ISNULL(@dt      ,'') + N'::' + ISNULL(@user    ,'') + N'::' + ISNULL(@username,'') + N'::'
