USE cfp 
GO
DROP PROCEDURE [dbo].[ep_timer_sono2]
GO
create procedure [dbo].[ep_timer_sono2]
as
begin
...
select  top 1 @menuflag = menuflag from timer_sono2
where ok = 'N'
...
SET @sql = '.dbo.ep_' + substring(@menuflag,1,6) + '_sono2_' + ' ''' + @menuflag + '''' 

EXEC sp_executesql @sql

if @@ERROR = 0   
   update TOP (1) timer_sono2 set ok='Y' , dt = getdate() 
