USE cfp 
GO
DROP PROCEDURE [dbo].[ep_timer_copy]
GO
create procedure [dbo].[ep_timer_copy]
as
begin
...
select  top 1 @menuflag = menuflag from timer_copy
where ok = 'N'
...
SET @sql = '.dbo.ep_' + substring(@menuflag,1,6) + '_copy_' + ' ''' + @menuflag + '''' 

EXEC sp_executesql @sql

if @@ERROR = 0   
   update TOP (1) timer_copy set ok='Y' , dt = getdate() 
